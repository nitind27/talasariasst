  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md bg-white border border-gray-200 rounded-xl p-6">
        ...
        <p className="text-sm text-gray-500 mb-6">Sign up to access the Admin Panel.</p>
        ...
        <div className="text-sm mt-4 text-center">
          ...
          <a href={`/login?next=${encodeURIComponent(next)}`} className="underline text-blue-700">Log in</a>
        </div>
      </div>
    </div>
  );
